...
type
  TFrMain = class(TForm)
    ...
    ImgMin: TImage;
    ImgExit: TImage;
    RStatusBar: TRectangle;
    Rectangle1: TRectangle;
    Label1: TLabel;
    Label2: TLabel;
    RHold: TRectangle;
    TmrOnAfterLoad: TTimer;
...
begin
  TLoginController.AbrirTelaLogin(nil, nil);
end;
...
procedure TFrMain.ImgCloseClick(Sender: TObject);
begin
  ImgExitClick(Nil);
end;

procedure TFrMain.ImgExitClick(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TFrMain.ImgMaxClick(Sender: TObject);
begin
