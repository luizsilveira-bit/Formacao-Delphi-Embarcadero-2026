...
//    MeuObj := obj;
   ...
   TParametros.ExecutarAlgo(num, b, c, bool, Str, Fl, Dt, SVariant, Ch,
      p , MeuObj);

   //Se fizer o FreeAndNil, dentro do metodo, ele limpa da memoria no Escopo Interno, e
   // Deixa assinado para limpar ao fim do escopo externo do metodo a cima
   //FreeAndNil(MeuObj); //Gera AV  
