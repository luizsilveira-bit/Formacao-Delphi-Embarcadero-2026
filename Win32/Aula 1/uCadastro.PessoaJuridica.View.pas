...
type
  TFormCadPessoaJuridica = class(TTFormCadPadrao)
    MemRegistroNomeFantasia: TStringField;
...
procedure TFormCadPessoaJuridica.FormCreate(Sender: TObject);
begin
  inherited;
  SetTituloTela('Cadastro de pessoa juridica');
end;
