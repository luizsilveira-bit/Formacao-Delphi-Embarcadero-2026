...
type
  ...
  private
    FHistorico: string;
    FChatGpt: TDinosChatGPT;
    FDraculaThemeChat: TDelphiSyntaxHighlighter;
...
begin
  inherited;
  FChatGpt := TDinosChatGPT.Create;
  FDraculaThemeChat := TDelphiSyntaxHighlighter.Create(mmoIA);

  FDraculaThemeChat.KeywordColor  := clFuchsia;
  FDraculaThemeChat.StringColor := clWebYellow;
  FDraculaThemeChat.CommentColor := clGrayText;
  FDraculaThemeChat.NumberColor := clPurple;
  FDraculaThemeChat.OperatorColor := clTeal;
  FDraculaThemeChat.IdentifierColor := clWhite;
...
begin
  ...
  if Assigned(FDraculaThemeChat) then
    FreeAndNil(FDraculaThemeChat);
...
begin
  ...
  begin
    ...
    mmoSelf.Lines.Clear;
    mmoIA.Lines.Add('$Chat diz: ');
    mmoIA.Lines.Add(FChatGpt.SendMessage(FHistorico));
    FDraculaThemeChat.HighlightAll;
  end;
end;
